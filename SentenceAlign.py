...
#Put it all together
sources, trans = GetSentences('texts/sources/hamanngermanfirst.txt', 'texts/sources/hamannenglishfirst.txt')
#sources, trans = GetSentences('../Novels/proustfr.txt', '../Novels/prousten.txt')
outsource, outtrans = AlignSentences(sources, trans, model)
write_to_json(outsource, outtrans, file_name='texts/aligned/hamannfirst.json')